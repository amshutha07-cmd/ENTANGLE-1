...
DARK = {
    ...
    "text": "#E7ECF5", "text_muted": "#93A0B8", "text_faint": "#66728A",
...
LIGHT = {
    ...
    "text": "#161E30", "text_muted": "#56627A", "text_faint": "#8892A6",
    "primary": "#3D63F0", "primary_hover": "#2F52D9", "primary_pressed": "#2545BD", "on_primary": "#FFFFFF",
    "primary_soft": "#E4EBFF",
    "success": "#0E9F6E", "success_soft": "#DDF7EC",
    "warning": "#B7791F", "warning_soft": "#FFF3D6",
    "danger": "#D64545", "danger_soft": "#FDE8E8",
...
QLabel[pill="primary"] {{ background: {t['primary_soft']}; color: {t['primary']}; border: 1px solid transparent; border-radius: 10px; padding: 3px 10px; font-size: 11px; font-weight: 700; }}
